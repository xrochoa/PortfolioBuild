$(function() {
    ...
    function animateIcons() {
        ...
        tl.fromTo($svgIntro, 2, { transformOrigin: '50% 50%', scale: 1 }, { scale: 1.1, ease: Sine.easeInOut })
            ...
            .to($icon1, 1, { x: '200px', opacity: 0.5, ease: Power4.easeOut }, '=-0.3')
            .to($icon2, 1, { x: '100px', opacity: 0.7, ease: Power4.easeOut }, '=-1')
            .to($icon3, 1, { x: '50px', opacity: 0.9, ease: Power4.easeOut }, '=-1')
            .to($icon5, 1, { x: '-200px', opacity: 0.5, ease: Power4.easeOut }, '=-1')
            .to($icon6, 1, { x: '-100px', opacity: 0.7, ease: Power4.easeOut }, '=-1')
            .to($icon4, 1, { x: '-50px', opacity: 0.9, ease: Power4.easeOut }, '=-1')
